...
```bash
[*]─[kc-debian13-test00-Klon]─[/kubecraft/DrewElliot_kubecraft/lessons/clab/01-containerlab-primer/topology]
└──> clab inspect
17:28:11 INFO Parsing & checking topology file=lab.clab.yml
╭─────────────────────┬───────────────────────────────┬─────────┬───────────────────╮
...
Because it is the only activated interface via configuration.
